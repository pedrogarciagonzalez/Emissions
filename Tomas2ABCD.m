...
%     end
    ...
    if Pline1_1(index,1) >= Psac1_1(index,1)
        indexSAC1_1 = indexSAC1_1+1;
        if Pline1_1(index,:) >= Psati(:) & Pline1_1(index,:) <= Psatw(:)
...
%     end
    ...
    if Pline1_2(index,1) >= Psac1_2(index,1)
        indexSAC1_2 = indexSAC1_2+1;
        if Pline1_2(index,:) >= Psati(:) & Pline1_2(index,:) <= Psatw(:)
...
%     end
    ...
    if Pline2_2(index,1) >= Psac2_2(index,1)
        indexSAC2_2 = indexSAC2_2+1;
        if Pline2_2(index,:) >= Psati(:) & Pline2_2(index,:) <= Psatw(:)
...
%     end
    ...
    if Pline1_3(index,1) >= Psac1_3(index,1)
        indexSAC1_3 = indexSAC1_3+1;
        if Pline1_3(index,:) >= Psati(:) & Pline1_3(index,:) <= Psatw(:)
...
%     end
    ...
    if Pline2_3(index,1) >= Psac2_3(index,1)
        indexSAC2_3 = indexSAC2_3+1;
        if Pline2_3(index,:) >= Psati(:) & Pline2_3(index,:) <= Psatw(:)
...
%     end
    ...
    if Pline1_4(index,1) >= Psac1_4(index,1)
        indexSAC1_4 = indexSAC1_4+1;
        if Pline1_4(index,:) >= Psati(:) & Pline1_4(index,:) <= Psatw(:)
...
%     end
    ...
    if Pline2_4(index,1) >= Psac2_4(index,1)
        indexSAC2_4 = indexSAC2_4+1;
        if Pline2_4(index,:) >= Psati(:) & Pline2_4(index,:) <= Psatw(:)
...
%     end
    ...
    if Pline1_5(index,1) >= Psac1_5(index,1)
        indexSAC1_5 = indexSAC1_5+1;
        if Pline1_5(index,:) >= Psati(:) & Pline1_5(index,:) <= Psatw(:)
...
%     end
    ...
    if Pline2_5(index,1) >= Psac2_5(index,1)
        indexSAC2_5 = indexSAC2_5+1;
        if Pline2_5(index,:) >= Psati(:) & Pline2_5(index,:) <= Psatw(:)
...
%     end
    ...
    if Pline1_6(index,1) >= Psac1_6(index,1)
        indexSAC1_6 = indexSAC1_6+1;
        if Pline1_6(index,:) >= Psati(:) & Pline1_6(index,:) <= Psatw(:)
...
%     end
    ...
    if Pline2_6(index,1) >= Psac2_6(index,1)
        indexSAC2_6 = indexSAC2_6+1;
        if Pline2_6(index,:) >= Psati(:) & Pline2_6(index,:) <= Psatw(:)
...
%     end
    ...
    if Pline1_7(index,1) >= Psac1_7(index,1)
        indexSAC1_7 = indexSAC1_7+1;
        if Pline1_7(index,:) >= Psati(:) & Pline1_7(index,:) <= Psatw(:)
...
%     end
    ...
    if Pline2_7(index,1) >= Psac2_7(index,1)
        indexSAC2_7 = indexSAC2_7+1;
        if Pline2_7(index,:) >= Psati(:) & Pline2_7(index,:) <= Psatw(:)
...
%     end
    ...
    if Pline1_8(index,1) >= Psac1_8(index,1)
        indexSAC1_8 = indexSAC1_8+1;
        if Pline1_8(index,:) >= Psati(:) & Pline1_8(index,:) <= Psatw(:)
...
%     end
    ...
    if Pline2_8(index,1) >= Psac2_8(index,1)
        indexSAC2_8 = indexSAC2_8+1;
        if Pline2_8(index,:) >= Psati(:) & Pline2_8(index,:) <= Psatw(:)
            indexpers2_8 = indexpers2_8+1;
        end
    end
end

percentSAC1_1=indexSAC1_1/(length(air_temp_AC1)-indexnotvalid1)*100;
percentSAC2_1=indexSAC2_1/(length(air_temp_AC1)-indexnotvalid1)*100;
percentSAC1_2=indexSAC1_2/(length(air_temp_AC2)-indexnotvalid2)*100;
percentSAC2_2=indexSAC2_2/(length(air_temp_AC2)-indexnotvalid2)*100;
percentSAC1_3=indexSAC1_3/(length(air_temp_AC3)-indexnotvalid3)*100;
percentSAC2_3=indexSAC2_3/(length(air_temp_AC3)-indexnotvalid3)*100;
percentSAC1_4=indexSAC1_4/(length(air_temp_AC4)-indexnotvalid4)*100;
percentSAC2_4=indexSAC2_4/(length(air_temp_AC4)-indexnotvalid4)*100;
percentSAC1_5=indexSAC1_5/(length(air_temp_AC5)-indexnotvalid5)*100;
percentSAC2_5=indexSAC2_5/(length(air_temp_AC5)-indexnotvalid5)*100;
percentSAC1_6=indexSAC1_6/(length(air_temp_AC6)-indexnotvalid6)*100;
percentSAC2_6=indexSAC2_6/(length(air_temp_AC6)-indexnotvalid6)*100;
percentSAC1_7=indexSAC1_7/(length(air_temp_AC7)-indexnotvalid7)*100;
percentSAC2_7=indexSAC2_7/(length(air_temp_AC7)-indexnotvalid7)*100;
percentSAC1_8=indexSAC1_8/(length(air_temp_AC8)-indexnotvalid8)*100;
percentSAC2_8=indexSAC2_8/(length(air_temp_AC8)-indexnotvalid8)*100;

%%Part D: persistent contrails
percentpers1_1=indexpers1_1/(length(air_temp_AC1)-indexnotvalid1)*100;
percentpers2_1=indexpers2_1/(length(air_temp_AC1)-indexnotvalid1)*100;
percentpers1_2=indexpers1_2/(length(air_temp_AC2)-indexnotvalid2)*100;
percentpers2_2=indexpers2_2/(length(air_temp_AC2)-indexnotvalid2)*100;
percentpers1_3=indexpers1_3/(length(air_temp_AC3)-indexnotvalid3)*100;
percentpers2_3=indexpers2_3/(length(air_temp_AC3)-indexnotvalid3)*100;
percentpers1_4=indexpers1_4/(length(air_temp_AC4)-indexnotvalid4)*100;
percentpers2_4=indexpers2_4/(length(air_temp_AC4)-indexnotvalid4)*100;
percentpers1_5=indexpers1_5/(length(air_temp_AC5)-indexnotvalid5)*100;
percentpers2_5=indexpers2_5/(length(air_temp_AC5)-indexnotvalid5)*100;
percentpers1_6=indexpers1_6/(length(air_temp_AC6)-indexnotvalid6)*100;
percentpers2_6=indexpers2_6/(length(air_temp_AC6)-indexnotvalid6)*100;
percentpers1_7=indexpers1_7/(length(air_temp_AC7)-indexnotvalid7)*100;
percentpers2_7=indexpers2_7/(length(air_temp_AC7)-indexnotvalid7)*100;
percentpers1_8=indexpers1_8/(length(air_temp_AC8)-indexnotvalid8)*100;
percentpers2_8=indexpers2_8/(length(air_temp_AC8)-indexnotvalid8)*100;
