...
tspan = 1940:1:2020;
[year,delta_ch4] = ode45(@(year,delta_ch4) first_order(year,delta_ch4,ch4_tchange,ch4_ppbv,tau),tspan,delta_ch4_std(1)*ones(81,1));
delta_ch4 = diag(delta_ch4);
[year,delta_ch4_1per] = ode45(@(year,delta_ch4_1per) first_order(year,delta_ch4_1per,ch4_tchange_1per,ch4_ppbv,tau),tspan,delta_ch4_std_1per(1)*ones(81,1));
delta_ch4_1per = diag(delta_ch4_1per);
[year,delta_ch4_const] = ode45(@(year,delta_ch4_const) first_order(year,delta_ch4_const,ch4_tchange_const,ch4_ppbv,tau),tspan,delta_ch4_std_const(1)*ones(81,1));
delta_ch4_const = diag(delta_ch4_const);
[year,delta_ch4_const1940] = ode45(@(year,delta_ch4_const1940) first_order(year,delta_ch4_const1940,ch4_tchange_const,ch4_ppbv,tau),tspan,delta_ch4_std_const1940(1)*ones(81,1));
delta_ch4_const1940 = diag(delta_ch4_const1940);
% for i = 2:1:81
