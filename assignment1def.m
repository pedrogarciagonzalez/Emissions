...
%part D
RF2008 = ((-1.3.*10.^(-6)).*(delta_ch4_rk4+2*1780)./2-(8.2*10.^(-6))*320+0.043).*(sqrt(delta_ch4_rk4+1780)-sqrt(1780))*1000; %mW m^2
RF2019 = ((-1.3.*10.^(-6)).*(delta_ch4_std+2*1780)./2-(8.2*10.^(-6))*320+0.043).*(sqrt(delta_ch4_std+1780)-sqrt(1780))*1000;
